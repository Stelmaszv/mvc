...
class one_to_one extends abstract_relation{
    function run(array $fun_argument,string $table): array
    {
        ...
        array_push($this->querys['actual'],$this->FOREIGN_KEY($fun_argument,$table));
        return $this->querys;
    }
    private function one_to_one(array $fun_argument,string $table):void
    {
        ...
        $query2="ALTER TABLE `".$fun_argument['FOREIGN_KEY_REFERENCES']."` ADD FOREIGN KEY (".$field_Name.") REFERENCES `".$table."`(id);";
